<?php
  if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
      addUser($user_firstname, $user_lastname, $username, $user_email, $user_phonenumber, $user_image, $tmp_user_image, $user_dob, $user_password, $user_role);
    }
  ...
  <form class="" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="col-12 col-sm-6 form-group">
        ...
        value="<?php if(isset($_POST['submit'])){ echo $_POST['user_firstname']; } ?>">
        <p class="text-danger">
          <?php
      ...
      <div class="col-12 col-sm-6 form-group">
        ...
        value="<?php if(isset($_POST['submit'])){ echo $_POST['user_lastname']; } ?>">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 form-group">
        ...
        value="<?php if(isset($_POST['submit'])){ echo $_POST['user_email']; } ?>">
        <p class="text-danger">
          <?php
    ...
    <div class="row">
      <div class="col-12 col-sm-12 form-group">
        ...
        value="<?php if(isset($_POST['submit'])){ echo $_POST['user_phonenumber']; } ?>">
        <p class="text-danger">
          <?php
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 form-group">
        ...
        value="<?php if(isset($_POST['submit'])){ echo $_POST['user_dob']; } ?>">
        <p class="text-danger">
          <?php
    ...
    <div class="row justify-content-center">
      <input type="submit" name="submit" value="Add User" class="btn btn-outline-success px-5">
    </div>
